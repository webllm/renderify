...
WebAssembly for declarative-only plans. Treat cancellation and teardown as
terminal so delayed tool responses cannot reactivate a view.
...
the repository MIT license in the published package.
