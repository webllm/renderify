...
export const FALLBACK_JSPM_CDN_BASE = "https://ga.jspm.io";
...
export const FALLBACK_REMOTE_MODULE_MAX_BYTES = 8 * 1024 * 1024;
...
export const FALLBACK_ALLOW_RUNTIME_SOURCE_EXECUTION = false;
