import type { JsonValue, RuntimeExecutionResult, RuntimeNode } from "@renderify/ir";
...
export class DefaultUIRenderer implements UIRenderer {
  async render(result: RuntimeExecutionResult, target?: RenderTarget): Promise<string> {
